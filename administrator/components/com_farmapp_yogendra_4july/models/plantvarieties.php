 ...
 */
class PlantvarietiesModelPlantvarieties extends FarmAppModelFarmApp
{
...
/**
	 ...
	 */
		function multiplepublish()
		{
		    ...
		    foreach($cids as $cid) {
			 	$query = 'UPDATE #__plant_variety SET status = 1'.
                		 '  WHERE id = '.$cid;  
                $db->setQuery($query);
                $db->query();
		     }
	 ...
	 */
		function multipleunpublish()
		{
		    ...
		    foreach($cids as $cid) {
				$query = 'UPDATE #__plant_variety SET status = 0'.
                		 '  WHERE id = '.$cid; 
                $db->setQuery($query);
                $db->query();
		     }
