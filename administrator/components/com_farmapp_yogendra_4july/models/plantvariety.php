...
class PlantvarietiesModelPlantvariety extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true) 
	{
		...
		// Get the form.
		$form = $this->loadForm('com_farmapp.plantvariety','plantvariety', array('load_data' => $loadData));
...
/**
	...
	public function save($data) 
	{
			...
			$row =& $this->getTable('Plantvariety','PlantvarietyTable');
			if($cid >0)
			{
			$row->load($cid,'id');
			}
...
/**
	...
	public function getItem($pk = null)
	{
		...
		$table = $this->getTable('Plantvariety','PlantvarietyTable');
		if ($pk > 0)
		{
