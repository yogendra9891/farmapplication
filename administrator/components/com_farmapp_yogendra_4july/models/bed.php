...
class BedsModelBed extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true) 
	{
		...
		// Get the form.
		$form = $this->loadForm('com_farmapp.bed','bed', array('load_data' => $loadData));
...
/**
	...
	public function getItem($pk = null)
	{
		...
		$table = $this->getTable('Bed','BedTable');
		if ($pk > 0)
		{
		...
		$item->farmzone=$item->farm.'/'.$item->zone;
