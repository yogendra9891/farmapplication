...
?>
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=plantvarieties'); ?>" method="post" name="adminForm" id="farm-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_FARMAPP_NEW_PLANT') : JText::sprintf('COM_FARMAPP_EDIT_PLANT', $this->item->id); ?></legend>
