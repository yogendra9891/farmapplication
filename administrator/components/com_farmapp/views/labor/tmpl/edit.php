...
?>
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=labors'); ?>" method="post" name="adminForm" id="farm-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_FARMAPP_NEW_LABOR_CAEGORY') : JText::sprintf('COM_FARMAPP_EDIT_LABOR_CAEGORY', $this->item->id); ?></legend>
			<ul class="adminformlist">
				...
				<li><?php echo $this->form->getLabel('unit_cost'); ?>
				<?php echo $this->form->getInput('unit_cost','',$this->item->unit_cost); ?></li>
