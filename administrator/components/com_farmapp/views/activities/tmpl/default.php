...
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=activities'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="filter-search fltlft">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_activity_status" class="inputbox" onchange="this.form.submit()">
				<?php echo JHtml::_('select.options', FarmappHelper::getActivityOptions(), 'value', 'text', $this->state->get('filter.activity_status'));?>
			</select>
