...
$userId	= $user->get('id');
	        ...
	        $link = JRoute::_( 'index.php?option=com_farmapp&view=labors&task=edit&cid[]='. (int)$row->id );

			$ordering	= ($this->state->get('list.ordering') == 'b.ordering');
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td>
		 ...
		 <?php } ?> 
				...
				<td>
		<?php if (isset($row->unit_cost)) { ?>
		<?php if ($canEdit) : ?>
			<a href="<?php echo $link; ?>"><?php echo $row->unit_cost; ?></a>
			<?php else : ?>
