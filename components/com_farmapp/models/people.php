...
class PeoplesModelPeople extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true) 
	{
		...
		// Get the form.
		$form = $this->loadForm('com_farmapp.people','people', array('load_data' => $loadData));
...
/**
	...
	public function save($data) 
	{
			...
			// Select a single field (farmid) from the farm table according the login user id.......
			$query->select('a.id');
...
/**
	...
	public function getItem($pk = null)
	{
		...
		$table = $this->getTable('People','PeopleTable');
		if ($pk > 0)
		{
