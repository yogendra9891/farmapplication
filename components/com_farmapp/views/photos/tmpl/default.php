...
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=photos'); ?>" method="post" name="adminForm" id="adminForm">
	   <h2 class="titleheadingfrontend">Photos</h2>
		<div id="zonestoolbar"><?php echo $this->getToolbar(); ?></div>
	<fieldset id="filter-bar">
	<div class="filter-search fltlft">
			<label class="filter-search-lbl" for="filter_search"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></label>
			<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_FARMAPP_SEARCH_IN_TITLE'); ?>" />
