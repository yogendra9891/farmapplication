...
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=peoples'); ?>" method="post" name="adminForm" id="adminForm">
	   <h2 class="titleheadingfrontend">Peoples</h2>
	...
	<div class="filter-search fltlft">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_labor_id" class="inputbox" onchange="this.form.submit()">
				<?php echo JHtml::_('select.options', FarmappHelper::getLaborOptions(), 'value', 'text', $this->state->get('filter.labor_id'));?>
			</select>
