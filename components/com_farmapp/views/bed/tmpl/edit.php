...
?>
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=beds'); ?>" method="post" name="adminForm" id="formId" >
    <div class="customcsstoolbar">
	<?php echo $this->getToolbar();?>
	 </div>
	<div class="width-60 fltlft">
		<fieldset class="adminform fieldsetborder">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_FARMAPP_NEW_BED') : JText::sprintf('COM_FARMAPP_EDIT_BED', $this->item->id); ?></legend>
			<ul class="adminformlist forfileds">
				...
				<li><?php echo $this->form->getLabel('zone'); ?>
				<?php echo $this->form->getInput('zone','',$this->item->zone); ?></li>
	...
	<div class="width-40 fltrt">
		...
		<input type="hidden" name="farm" value="<?php echo $this->item->farm; ?>">
