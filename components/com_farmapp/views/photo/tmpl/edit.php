...
?>
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=photos'); ?>" method="post" name="adminForm" id="farm-form" class="form-validate">
    <div class="customcsstoolbar">
	<?php echo $this->getToolbar();?>
	</div>
	<div class="width-60 fltlft imagepreview">
		<fieldset class="adminform fieldsetborder">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_FARMAPP_NEW_PHOTOS') : JText::sprintf('COM_FARMAPP_EDIT_PHOTOS', $this->item->id); ?></legend>
			<ul class="adminformlist forfileds">
				...
				<li class="selectimageclass"><?php echo $this->form->getLabel('image'); ?>
				<?php echo $this->form->getInput('image','',$this->item->image); ?></li>
