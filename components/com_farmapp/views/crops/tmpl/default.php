...
<form action="<?php echo JRoute::_('index.php?option=com_farmapp&view=crops'); ?>" method="post" name="adminForm" id="adminForm">
	   <h2 class="titleheadingfrontend">Crops</h2>
	...
	<div class="filter-search fltlft">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_bed_id" class="inputbox" onchange="this.form.submit()">
				<?php echo JHtml::_('select.options', FarmappHelper::getBedOptions(), 'value', 'text', $this->state->get('filter.bed_id'));?>
			</select>
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_zone_id" class="inputbox" onchange="this.form.submit()">
				<?php echo JHtml::_('select.options', FarmappHelper::getZoneOptions(), 'value', 'text', $this->state->get('filter.zone_id'));?>
			</select>
